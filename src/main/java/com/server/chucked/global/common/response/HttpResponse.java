package com.server.chucked.global.common.response;
...
public class HttpResponse {
    ...
    public enum Fail {
        ...
        TEXT_MAX_LENGTH(HttpStatus.BAD_REQUEST, "최대 15자까지 입력할 수 있습니다."),
        TEXT_NOT_SPECIAL(HttpStatus.BAD_REQUEST, "특수문자는 (), [], +, -, &, /, _ 만 가능합니다"),
        TEXT_NOT_KAKAO(HttpStatus.BAD_REQUEST, "\"카카오\"가 포함된 문구는 담당 MD와 협의한 경우에만 사용할 수 있습니다"),
